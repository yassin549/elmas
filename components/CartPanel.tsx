            ...
            {cartItems.length === 0 ? (
              <div className='flex-grow flex flex-col justify-center items-center text-center p-6'>
                ...
                <Link
                  href='/'
                  onClick={onClose}
                  className='mt-4 px-6 py-2 bg-black text-white text-sm uppercase tracking-wider'
                >
            ...
            {cartItems.length > 0 && (
              <div className='p-6 border-t'>
                ...
                <Link
                  href='/checkout'
                  onClick={onClose}
                  className='w-full block text-center py-3 bg-black text-white text-sm uppercase tracking-wider'
                >
                  Passer la commande
                </Link>
              </div>
